...
Bar::Bar(int& current, int& total, float barscale, SDL_Colour fillcolour, SDL_Colour framecolour)
	: m_WatchCurrent(current), m_WatchTotal(total), m_cFrameColour(framecolour), m_cFillColour(fillcolour),
...
HealthBar::HealthBar(GameObject& object, int& current, int& total, float barscale, SDL_Colour fillcolour, SDL_Colour framecolour)
	: Bar(current, total, barscale, fillcolour, framecolour), m_WatchObject(object) {}
...
UIBar::UIBar(int x, int y, int& current, int& total, float barscale, SDL_Colour fillcolour, SDL_Colour framecolour)
	: Bar(current, total, barscale, fillcolour, framecolour), m_iXPos(x), m_iYPos(y)
{
	m_rFrame.x = m_iXPos;
	m_rFrame.y = m_iYPos;
}