...
public:
	...
	static bool squaredRadiusCheck(glm::vec2 position, float radius, GameObject* object2);
	...
	static bool lineAABBCheck(glm::vec2 start, glm::vec2 end, GameObject* object);
